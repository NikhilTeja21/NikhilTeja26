...
st.set_page_config(page_title="Data Analysis",page_icon=":chart_with_downwards_trend:",layout="wide")
...
lottie_coding2 = Graphical_Content("https://assets6.lottiefiles.com/packages/lf20_1elvfrxr.json")
...
with st.container() :
    ...
    st.write("[Github...](https://github.com/vishnu-priya-42/abcd)")
    st.write("[LinkedIn...](https://www.linkedin.com/in/vishnu-priya-mamidi-43638b22a/)")